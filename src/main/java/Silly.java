...
public class Silly implements Comparable<Silly>{
     ...
     * This constructor
     *
     * @param first a string that will become the first portion of this instance's name.
     * @param second a string that will become the second portion of this instance's name.
     */
